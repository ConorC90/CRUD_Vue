...
itemRoutes.route("/update/:id").post(function(req, res) {
  Item.findById(req.params.id, function(err, item) {
    if (!item) return next(new Error("Could not load Document"));
      ...
      item.iata = req.body.iata;
      item.bags = req.body.bags;
      item.checkin = req.body.checkin;
      item.seats = req.body.seats;
      item.name = req.body.name;
      item.primary_color = req.body.primary_color;
      item.secondary_color = req.body.secondary_color;
